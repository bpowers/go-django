...
/*
	The signedcookie package implements read-only access to
...
// Decode returns a map corresponding to the object encoded and signed
// by the django.contrib.sessions.backends.signed_cookies
